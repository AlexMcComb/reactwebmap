...
class App extends Component {
  ...
  componentDidMount() {
    ...
    navigator.geolocation.getCurrentPosition((position) => {
      ...
      console.log("uh oh, they didn't give us a location");
    ...
    return (
      <div className="map">
        ...
        <Card body className="message-form">
          <CardTitle>Welcome to my guest map!</CardTitle>
          <CardText>Leave a message with your location!</CardText>
          {
            !this.state.sendingMessage && !this.state.sentMessage && this.state.haveUsersLocation ?
              <Form onSubmit={this.formSubmitted}>
                ...
                {/*Disabled button if we don't have users location*/}
              ...
              this.state.sendingMessage || !this.state.haveUsersLocation ?
                <img src="https://i.giphy.com/media/KzF4bTM9CkiU8/giphy-downsized.gif" alt="loading icon" /> :
